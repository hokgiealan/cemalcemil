...
class SingleItemlauk extends StatefulWidget {
  final List<String> menu;

  const SingleItemlauk({Key? key, required this.menu}) : super(key: key);

  @override
  State<SingleItemlauk> createState() => _SingleItemState();
}

class _SingleItemState extends State<SingleItemlauk> {
  @override
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => lauk(), // Ganti dengan Kripik()
                      ),
                    );
                  },
                  child: Padding(
